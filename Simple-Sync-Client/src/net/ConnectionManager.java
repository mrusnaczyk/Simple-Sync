...
public class ConnectionManager {
	...
	private void verifyClient() {
		try {
			...
			CookieHandler.setDefault(chocolateChip);
			HttpsURLConnection conn = (HttpsURLConnection) getURLConnection(
					"/auth/clientVerify.php?key=" + secrets + "&clientName=" + client);
			...
			JOptionPane.showMessageDialog(null, "Uh oh! Something went wrong! Restart the program and try again.",
